describe('CoreSlider Unit Tests', () => {
  ...
  describe('control', () => {
    ...
    xit('should not give control menu and control arrows when the control attribute is given an illegal value', () => {
    ...
    xit('should remove control menu and control arrows when the control attribute is changed to an illegal value', () => {

    });

    xdescribe('tests for control ability', () => {
